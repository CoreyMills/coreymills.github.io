...
window.addEventListener('scroll',function(){$('.dropDownContent')[0].style.display="none";})
document.onreadystatechange=function(e){if (document.readyState === 'complete'){UpdateNav();}}
